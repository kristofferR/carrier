...
(function () {
  ...
  const AUTH_HOSTS = ["accounts.google.com", "login.microsoftonline.com", "appleid.apple.com", "github.com"];
  const AUTH_PATHS = ["/oauth", "/o/oauth2", "/authorize", "/signin", "/login", "/dialog/oauth"];
  function isAuth(u) {
